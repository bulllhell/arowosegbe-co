        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-6">
              ...
              <a
                href="mailto:hello@arowosegbe.com"
                className="w-9 h-9 rounded-full border border-white/20 flex items-center justify-center text-white/60 hover:text-brand-orange hover:border-brand-orange transition-colors"
                aria-label="Email"
              >
                <RiMailLine size={15} />
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <a href="tel:+2348000000000" className="text-sm text-white/70 hover:text-white transition-colors">
                  +234 800 000 0000
                </a>
              </li>
              <li className="flex items-start gap-3">
              ...
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:hello@arowosegbe.com" className="text-sm text-white/70 hover:text-white transition-colors">
                  hello@arowosegbe.com
                </a>
              </li>
              <li className="flex items-start gap-3">
